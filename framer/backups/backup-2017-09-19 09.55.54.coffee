...
updateList = ->
	if lists[0].height==90 && lists[1].height!=90 && lists[2].height!=90 && lists[3].height!=90 && lists[4].height!=90
		...
		print "Only fabric, fit, collar active"
		...
		print "Only fabric, fit, collar, cuff active"
